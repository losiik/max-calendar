...
class NotificationService:
    ...
    def message_builder_new_slot(self, notification_data: Notification):
        ...
        meet_start_at = meet_start_at.strftime("%d.%m.% %H:%M")
        meet_end_at = meet_end_at.strftime("%d.%m.% %H:%M")
...
Время: с {meet_start_at} по {meet_end_at}
    ...
    def message_invited_builder_confirm_slot(
        ...
        invited_meet_start_at = invited_meet_start_at.strftime("%d.%m.% %H:%M")
        invited_meet_end_at = invited_meet_end_at.strftime("%d.%m.% %H:%M")
...
Ссылка на встречу: {notification_data.meeting_url}
    ...
    def message_owner_builder_confirm_slot(self, notification_data: ConfirmTimeSlotNotification):
        ...
        owner_meet_start_at = owner_meet_start_at.strftime("%d.%m.% %H:%M")
        owner_meet_end_at = owner_meet_end_at.strftime("%d.%m.% %H:%M")
