...
export function WorkingHoursContent() {
  ...
  return (
    ...
    <CellList >
      <Typography.Title  variant="large-strong">Мне можно ставить встречи с</Typography.Title>
      <TimeRangeInput
        hours={fromHours}
        minutes={fromMinutes}
      ...
      />
      <Typography.Title  variant="large-strong">Мне можно ставить встречи до</Typography.Title>
      <TimeRangeInput
        hours={toHours}
        minutes={toMinutes}
      ...
      />
      <Button data-haptic="success" className="w-full mt-4" appearance="themed" mode="primary" size="medium" onClick={save} disabled={isPending}>
